...
@section('konten')
    ...
    <div class="container">
      <div class="Konten">
        ...
        $SqlQuery = mysqli_query($con, "SELECT * FROM bootstrap LIMIT ".$limitStart.",".$limit);
        $no = $limitStart + 1;
        ...
        ?>
                ...
                <div class="card">
                    <a href="../Tutorial/Bootstrap/<?php echo $row['berkas_produk']; ?>"> 
                    <div class="KontenCard">
                        <img alt="Tutorial Bootstrap" class="lazy" src="../blank.jpg" data-original="../GambarTutorial/Bootstrap/<?php echo $row['gambar_produk']; ?>"> 
                    </a>     
                        <p> <a id="Tag" href="#"> Bootstrap </a> </p> <br>
                        <a href="../Tutorial/Bootstrap/<?php echo $row['berkas_produk']; ?>">
        ...
        <div class="Pagination">
            ...
            <div class="Back">
                ...
                ?>
                    <a href="bootstrap.php?page=<?php echo $LinkPrev; ?>">
                        <button> &laquo; </button> 
                    </a>
                <?php
                }
            ...
            <?php
            $SqlQuery = mysqli_query($con, "SELECT * FROM bootstrap");        
            ...
            ?>
                <a href="bootstrap.php?page=<?php echo $i; ?>">
            ...
            ?>
                <a href="bootstrap.php?page=<?php echo $linkNext; ?>">
                    <button> &raquo; </button>
                </a>
            <?php
                }
