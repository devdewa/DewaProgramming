...
@section('konten')
    ...
    <div class="content-wrapper">
        ...
        <div class="container-fluid">
            <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0 text-dark">Postingan Baru Tutorial</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="/segel/tutorial">Home</a></li>
                <li class="breadcrumb-item active">Postingan Baru Tutorial</li>
                </ol>
            </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
            ...
            <div class="row">
                ...
                <div class="card-body">
                    <form action="{{route('tutorial.store')}}" method="post" enctype="multipart/form-data">
                        ...
                        <input type="text" name="category" id="category" class="form-control" aria-describedby="post" require>
                        </div>
