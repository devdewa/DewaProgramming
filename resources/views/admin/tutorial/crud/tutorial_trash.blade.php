	...
	<div class="container">
		...
		<div class="card mt-5">
			<div class="card-body">
				...
				<a href="/segel/tutorial" class="btn btn-danger">Kembali</a> 
 
				<br/>
				<br/>
 
				<a href="/segel/tutorial/kembalikan_semua">Kembalikan Semua</a>
				|
				<a href="/segel/tutorial/hapus_permanen_semua">Hapus Permanen Semua</a>
				<br/>
				<br/>
				...
				<table class="table table-bordered">
					...
					<tbody>
						@foreach($tutorial as $g)
						<tr>
							<td>{{ $g->judul }}</td>
                            <td class="text-center">{{ $g->tag }}</td>
							<td class="text-center"><a href="/segel/tutorial/kembalikan/{{ $g->id }}" class="btn btn-success btn-sm">Restore</a></td>	
							<td class="text-center"><a href="/segel/tutorial/hapus_permanen/{{ $g->id }}" class="btn btn-danger btn-sm">Deleted</a></td>
						</tr>
						@endforeach
					</tbody>
				</table>
